...
const topRated = () => {
    ...
    const [topRatedShows, setTopRatedShows] = useState<TmdbTvResult[]>([]);
    const [pageCount, setPageCount] = useState<number>(1);

    useEffect(() => {
        axios.get('http://localhost:3001/shows/top-rated', {
            params: {
                page: pageCount
            }
        }).then((res) => {
            ...
            setTopRatedShows((prevMovies) => [...prevMovies, ...showsWithMediaType])
