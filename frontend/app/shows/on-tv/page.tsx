...
const showsOnAir = () => {
    ...
    const [showsOnAir, setShowsOnAir] = useState<TmdbTvResult[]>([]);
    const [pageCount, setPageCount] = useState<number>(1);

    useEffect(() => {
        axios.get('http://localhost:3001/shows/on-air', {
            params: {
                page: pageCount
            }
        }).then((res) => {
            ...
            setShowsOnAir((prevMovies) => [...prevMovies, ...showsWithMediaType])
