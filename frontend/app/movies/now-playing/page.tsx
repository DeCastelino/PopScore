...
const NowPlaying = () => {
    ...
    const [nowPlaying, setNowPlaying] = useState<TmdbMovieResult[]>([]);
    const [pageCount, setPageCount] = useState<number>(1);

    useEffect(() => {
        axios.get('http://localhost:3001/now-playing', {
            params: {
                page: pageCount
            }
        }).then((res) => {
            ...
            setNowPlaying((prevMovies) => [...prevMovies, ...moviesWithMediaType])
