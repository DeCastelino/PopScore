  ...
  return (
    <div className="relative bg-inherit text-white py-3 px-6 shadow-none mb-10">
      <nav className="flex items-center justify-between max-w-7xl mx-auto">
        {/* Left Side: Logo */}
        <div className="text-3xl font-extrabold italic tracking-wide text-white cursor-pointer">
          <Link href='/'>
            PopScore
          </Link>
        </div>
        ...
        {user ? (
          ...
          <div className="flex space-x-4">
            <button className="outline-none border border-orange-500 py-2 px-5 rounded-full font-medium italic">LOGIN</button>
            <button className="outline-none bg-orange-500 py-2 px-5 rounded-full font-medium italic">SIGN UP</button>
          </div>
        )}
